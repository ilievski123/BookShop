...
class Admin extends Controller
{
    ...
    public function categories()
    {
        ...
        if (strlen($tableHTML == "")) {
            $noCat =  "<p class='text-center'>Празно !</p>";
        }
    ...
    public function products($method = false, $arg = "")
    {
        ...
        if ($method === "add") {
            ...
            if (strlen($tableHTML == "")) {
                $noProd =  "<p class='text-center'>Празно !</p>";
            }

            $data['noProd'] = $noProd;
            $data['tableHTML'] = $tableHTML;
            $data['pageTitle'] = "Admin - Книги";
    ...
    public function commands()
    {
        ...
        if (strlen($commandsHTML == "")) {
            $noCom =  "<p class='text-center'>Празно !</p>";
        }
    ...
    public function addProduct($data, $productModel)
    {
        ...
        $data['pageTitle'] = "Admin - Додај книга";
    ...
    public function viewCustomers($data, $user)
    {
        ...
        if (strlen($customersHTML == "")) {
            $noCus =  "<p class='text-center'>Прано!</p>";
        }
