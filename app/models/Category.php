        ...
        if (is_array($categories)) {
            foreach ($categories as $category) {
                ...
                $tableHTML .= '<tr>
                            ...
                            <td><button class="btn btn-primary" onclick="displayEditForm(' . $args . ')">Измени</button></td>
                            <td><button class="btn btn-warning" onclick="deleteCategory(' . $category->idCategory . ')">Избриши</button></td>
                        </tr>';
            }
        }
        return $tableHTML;
