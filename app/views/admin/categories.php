...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h1 class="text-center">Категории на книги</h1>
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="col-8">
            <button class="btn btn-primary" id="btnSubmit" onclick="displayForm()">Додај категорија</button>
        </div>
        <div class="col-8 formCat">
            <form action="" method="POST">
                <div class="mb-3">
                    <label for="name" class="form-label">Име на категорија : </label>
                    <input id="inputAddCat" type="text" name='name' class="form-control">
                </div>
                <button type="button" onclick="collectDataCat()" class="btn btn-primary">Потврди</button>
                <button type="button" onclick="displayForm()" class="btn btn-warning">Избриши</button>
            </form>
        </div>
        <div class="col-8 formEditCat hide">
            <form action="" method="POST">
                <div class="mb-3">
                    <label for="name" class="form-label">Ново име на категорија : </label>
                    <input id="inputEditCat" type="text" name='name' class="form-control">
                </div>
                <button type="button" id="btnEditCat" onclick="collectDataEditCat()" class="btn btn-primary">Потврди</button>
                <button type="button" onclick="displayEditForm()" class="btn btn-warning">Затвори</button>
            </form>
        </div>
        <div class="row justify-content-center">
            <div class="col-8">
